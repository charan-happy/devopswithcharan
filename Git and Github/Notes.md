...
- A system which involves the modification of code of a present system

- Git is not only DVCs existing. There are many others too. Like ******************************************Mercurial, Bitkeeper, Darcs, Bazaar******************************************
- The file extension for git is “.git”
...
- It is a history re-writing command

**********************************when is it used ?**********************************

- you have made a local commit which is incorrect in terms of the commit content or the commit message

************************************************************Benefits of using this command************************************************************

- This will overlap your incorrect ( and the most recent) commit with the current one. In this way, the incorrect commit gets completely removed from the repo history.

********************************Checkout command********************************

- The command that helps you in visiting a different version of the same project in terms of a file, a commit or even a branch

********When is it used ?********

It can be used in 3 instances

- You need to have a look at a previous version of a file
- You need to have a look at that version of the project existing when a particular commit was the HEAD of the repository
- You need to compare files and folders with a different branch of the same repository.

******************Benefits****************** 

- Helps switch between branches

****************************Revert command****************************

- A ctrl+Z function in git which performs an undo on a commit. While also preserving it as a commit in the history.

**********************************when is it used ?**********************************

- To remove the changes that were made on a particular commit, the action of revert is preserved as a new and recent most commit in the local repository and can also be pushed to upstream if required.

****************Benefits**************** 

- Helps to undo unwanted commits

******Cherry pick command******

- A command to merge only single commits from one branch to the HEAD of the current branch

**********************************when is it used ?**********************************

- when merging of two branches in unnecessary or not feasible and only a single/handful commits are needed in current branch

**************Benefit**************

- Helps select commits to merge

************************squash command************************

- A command to merge concurrent commits as a single commit

**********************************When is it used ?**********************************

- In order to have a cleaner history which enhances readability of the history tree, two commits can be squeezed into a single commit.

**************Benefit**************

- Merge concurrent commits to a single commit to keep the history clean

**************************Reset command**************************

- A command that permanently removes the commit it gets acted upon

**********************************when is it used ?**********************************

- used in order to remove files from the git staging area.
- used to permanently delete commits from the history and resetting the changes that were made in those commits

**************Benefit**************

- Removes commits which are not needed, but has to be used with caution, helps keep history clean

**************************clean command**************************

- A command that helps you in getting rid of untracked files that are not required anymore.

**********************************When is it done ?**********************************

- Too many untracked files that are not required to be added to the working directory

**************Benefit**************

- Helps keep repositories clean by removing files that are not needed to be tracked by git
...
- It allows you to keep track of all the changes made to a file or set of files, as well as who made the changes, when the changes were made, and why the changes were made. Version control is commonly used in software development, but it can also be used for other types of files, such as documents, spreadsheets, and images.

### Why use Version control system

- **Keep Track of changes :** Version control allows you to keep track of changes made to a file or a set of files over time. You can see who made what changes, when the changes were made, and why the changes were made. This can be particularly helpful when trying to troubleshoot or debug an issue.
- **Collaboration :**: Version control enables multiple people to work on the same files at the same time without overwriting each other's changes. This can be particularly helpful when working on a project with a team of people.
- **Versioning :** With version control, every change is saved, so you can go back to previous versions if needed. This can be particularly helpful when you need to revert to an earlier version of a file, or when you need to see how a file has changed over time.
- **Branching and Merging :** Version control allows you to work on multiple versions of a file simultaneously and merge changes together. This can be particularly helpful when you want to experiment with a new feature or fix a bug without affecting the main codebase.
- **Backup :** : Version control systems provide a form of backup for your files, as they are stored in a central repository. This can be particularly helpful in case of hardware failure or other catastrophic events.
...
!https://user-images.githubusercontent.com/89054489/218244876-691578c1-e3c1-438d-becd-38bfe4192cd3.png
...
- if you are on commit **D** and you run git cherry-pick **F**, Git will take that changes that are introduced in commit **F** and replay them as new commit(shown as 'F`') on top of commit **D**
    ...
    !https://user-images.githubusercontent.com/89054489/218245440-2e306048-0a61-4caf-81e1-56467b952111.png
...
- A common workflow in git is to develop feature on small branches and merge the features one at a time into the masters branch.
    ...
    !https://user-images.githubusercontent.com/89054489/218246806-08a20b41-183a-4dbc-b734-e83a8f80e77f.png
...
**Rebasing :** `$ git rebase <base> <target>`
...
- Learn the basics of Git, including creating repositories, branching, merging, and resolving conflicts.
- Practice using Git commands through tutorials and exercises.
- Collaborate on a small project using Git.
...
- The '.git' directory
    ...
    !https://private-user-images.githubusercontent.com/89054489/250337797-8b578a6a-8c27-4380-9208-a32ced7fd47d.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..rcsdSq1BPfdtWitvUXkIlZCCb7HlKI-AwA-qlLjAhr8
...
!https://private-user-images.githubusercontent.com/89054489/250338056-31ea48da-9f8a-428c-a52e-713e8d8bced5.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..3xE0xgRLAwVKWX96xjN0xFSLlVSW27xIdL03CtnYgRk
...
- we can use `git checkout [SHA1]` to go back to any history versions.
    ...
    !https://private-user-images.githubusercontent.com/89054489/250338153-29cda767-9ae7-4891-8696-f5f852a6570b.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..5R40Ho3pfqm_lrUA3f8yzZUbcoVsaMy-uvV-PatoREU
...
- Head point to the baseline of our current working directory (only one per repo)
    ...
    !https://private-user-images.githubusercontent.com/89054489/251163832-ffa02d14-2071-48ac-9ee1-52189d20fa7c.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..1l0lchJDhsTRMkFc5KWSU8bo8bRROq0KMhYXixq_va0
    ...
    - Hard reset(1+2+3)
        ...
        using --hard reset, may lose your work
